...
class Change extends AbstractSoapClientBase
{
    ...
    /**
     * Method to call the operation originally named changeOwnPassword
     ...
     * @param \SFPartnerApi\v480\StructType\ChangeOwnPassword $parameters
     * @return \SFPartnerApi\v480\StructType\ChangeOwnPasswordResponse|bool
     */
    public function changeOwnPassword(\SFPartnerApi\v480\StructType\ChangeOwnPassword $parameters)
    {
        try {
            $this->setResult($this->getSoapClient()->changeOwnPassword($parameters));
