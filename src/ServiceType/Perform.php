...
class Perform extends AbstractSoapClientBase
{
    ...
    /**
     * Method to call the operation originally named performQuickActions
     ...
     * - documentation: Perform a series of predefined actions such as quick create or log a task
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \SFPartnerApi\v480\StructType\PerformQuickActions $parameters
     * @return \SFPartnerApi\v480\StructType\PerformQuickActionsResponse|bool
     */
    public function performQuickActions(\SFPartnerApi\v480\StructType\PerformQuickActions $parameters)
    {
        try {
            $this->setResult($this->getSoapClient()->performQuickActions($parameters));
