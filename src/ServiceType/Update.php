...
class Update extends AbstractSoapClientBase
{
     ...
     * - documentation: Update a set of sObjects
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \SFPartnerApi\v480\StructType\Update $parameters
     * @return \SFPartnerApi\v480\StructType\UpdateResponse|bool
     */
    public function update(\SFPartnerApi\v480\StructType\Update $parameters)
    {
        try {
