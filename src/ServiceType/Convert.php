...
class Convert extends AbstractSoapClientBase
{
    ...
    /**
     * Method to call the operation originally named convertLead
     ...
     * - documentation: convert a set of leads
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \SFPartnerApi\v480\StructType\ConvertLead $parameters
     * @return \SFPartnerApi\v480\StructType\ConvertLeadResponse|bool
     */
    public function convertLead(\SFPartnerApi\v480\StructType\ConvertLead $parameters)
    {
        try {
            $this->setResult($this->getSoapClient()->convertLead($parameters));
