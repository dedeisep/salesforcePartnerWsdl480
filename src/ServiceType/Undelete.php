...
class Undelete extends AbstractSoapClientBase
{
     ...
     * - SOAPHeaderNames: SessionHeader, CallOptions, AllowFieldTruncationHeader, DisableFeedTrackingHeader, StreamingEnabledHeader, AllOrNoneHeader, DuplicateRuleHeader, LocaleOptions, DebuggingHeader, PackageVersionHeader
     * - SOAPHeaderNamespaces: urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com, urn:partner.soap.sforce.com
     ...
     * - SOAPHeaders: required, required, required, required, required, required, required, required, required, required
     * - documentation: Undelete a set of sObjects
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \SFPartnerApi\v480\StructType\Undelete $parameters
     * @return \SFPartnerApi\v480\StructType\UndeleteResponse|bool
     */
    public function undelete(\SFPartnerApi\v480\StructType\Undelete $parameters)
    {
        try {
            $this->setResult($this->getSoapClient()->undelete($parameters));
