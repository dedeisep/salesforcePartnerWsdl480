...
class Merge extends AbstractSoapClientBase
{
     ...
     * - SOAPHeaderNames: SessionHeader, CallOptions, AssignmentRuleHeader, MruHeader, AllowFieldTruncationHeader, DisableFeedTrackingHeader, StreamingEnabledHeader, DuplicateRuleHeader, LocaleOptions, DebuggingHeader, PackageVersionHeader, EmailHeader
     ...
     * - documentation: Merge and update a set of sObjects based on object id
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \SFPartnerApi\v480\StructType\Merge $parameters
     * @return \SFPartnerApi\v480\StructType\MergeResponse|bool
     */
    public function merge(\SFPartnerApi\v480\StructType\Merge $parameters)
    {
        try {
            $this->setResult($this->getSoapClient()->merge($parameters));
