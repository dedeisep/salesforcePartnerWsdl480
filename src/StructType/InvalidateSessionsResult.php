...
/**
 * This class stands for InvalidateSessionsResult StructType
 * @subpackage Structs
 */
class InvalidateSessionsResult extends AbstractStructBase
{
    /**
     * The errors
    ...
    public $success;
    /**
     * Constructor method for InvalidateSessionsResult
     * @uses InvalidateSessionsResult::setErrors()
     * @uses InvalidateSessionsResult::setSuccess()
    ...
    public static function validateErrorsForArrayConstraintsFromSetErrors(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $invalidateSessionsResultErrorsItem) {
            // validation for constraint: itemType
            if (!$invalidateSessionsResultErrorsItem instanceof \SFPartnerApi\v480\StructType\Error) {
                $invalidValues[] = is_object($invalidateSessionsResultErrorsItem) ? get_class($invalidateSessionsResultErrorsItem) : sprintf('%s(%s)', gettype($invalidateSessionsResultErrorsItem), var_export($invalidateSessionsResultErrorsItem, true));
            }
        }
     ...
     * @param \SFPartnerApi\v480\StructType\Error[] $errors
     * @return \SFPartnerApi\v480\StructType\InvalidateSessionsResult
     */
