...
/**
 * This class stands for UpsertResult StructType
 * @subpackage Structs
 */
class UpsertResult extends AbstractStructBase
{
    /**
     * The created
     * @var bool
     ...
     * @uses UpsertResult::setCreated()
     * @uses UpsertResult::setErrors()
     * @uses UpsertResult::setId()
     * @uses UpsertResult::setSuccess()
     * @param bool $created
     * @param \SFPartnerApi\v480\StructType\Error[] $errors
     * @param string $id
     * @param bool $success
     */
    public function __construct($created = null, array $errors = array(), $id = null, $success = null)
    {
        $this
            ->setCreated($created)
            ->setErrors($errors)
     ...
     * Set created value
     * @param bool $created
     * @return \SFPartnerApi\v480\StructType\UpsertResult
     */
    ...
    public static function validateErrorsForArrayConstraintsFromSetErrors(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $upsertResultErrorsItem) {
            // validation for constraint: itemType
            if (!$upsertResultErrorsItem instanceof \SFPartnerApi\v480\StructType\Error) {
                $invalidValues[] = is_object($upsertResultErrorsItem) ? get_class($upsertResultErrorsItem) : sprintf('%s(%s)', gettype($upsertResultErrorsItem), var_export($upsertResultErrorsItem, true));
            }
        }
