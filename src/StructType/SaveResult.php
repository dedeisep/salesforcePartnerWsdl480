...
/**
 * This class stands for SaveResult StructType
 * @subpackage Structs
 */
class SaveResult extends AbstractStructBase
{
    /**
     * The errors
    ...
    public $success;
    /**
     * Constructor method for SaveResult
     * @uses SaveResult::setErrors()
     * @uses SaveResult::setId()
     * @uses SaveResult::setSuccess()
    ...
    public static function validateErrorsForArrayConstraintsFromSetErrors(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $saveResultErrorsItem) {
            // validation for constraint: itemType
            if (!$saveResultErrorsItem instanceof \SFPartnerApi\v480\StructType\Error) {
                $invalidValues[] = is_object($saveResultErrorsItem) ? get_class($saveResultErrorsItem) : sprintf('%s(%s)', gettype($saveResultErrorsItem), var_export($saveResultErrorsItem, true));
            }
        }
     ...
     * @param \SFPartnerApi\v480\StructType\Error[] $errors
     * @return \SFPartnerApi\v480\StructType\SaveResult
     */
