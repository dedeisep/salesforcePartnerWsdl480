...
/**
 * This class stands for sendEmailMessageResponse StructType
 * @subpackage Structs
 */
class SendEmailMessageResponse extends AbstractStructBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for sendEmailMessageResponse
     * @uses SendEmailMessageResponse::setResult()
    ...
    public static function validateResultForArrayConstraintsFromSetResult(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $sendEmailMessageResponseResultItem) {
            // validation for constraint: itemType
            if (!$sendEmailMessageResponseResultItem instanceof \SFPartnerApi\v480\StructType\SendEmailResult) {
                $invalidValues[] = is_object($sendEmailMessageResponseResultItem) ? get_class($sendEmailMessageResponseResultItem) : sprintf('%s(%s)', gettype($sendEmailMessageResponseResultItem), var_export($sendEmailMessageResponseResultItem, true));
            }
        }
     ...
     * @param \SFPartnerApi\v480\StructType\SendEmailResult[] $result
     * @return \SFPartnerApi\v480\StructType\SendEmailMessageResponse
     */
