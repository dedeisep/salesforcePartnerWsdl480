...
/**
 * This class stands for retrieveMassQuickActionTemplatesResponse StructType
 * @subpackage Structs
 */
class RetrieveMassQuickActionTemplatesResponse extends AbstractStructBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for retrieveMassQuickActionTemplatesResponse
     * @uses RetrieveMassQuickActionTemplatesResponse::setResult()
    ...
    public static function validateResultForArrayConstraintsFromSetResult(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $retrieveMassQuickActionTemplatesResponseResultItem) {
            // validation for constraint: itemType
            if (!$retrieveMassQuickActionTemplatesResponseResultItem instanceof \SFPartnerApi\v480\StructType\QuickActionTemplateResult) {
                $invalidValues[] = is_object($retrieveMassQuickActionTemplatesResponseResultItem) ? get_class($retrieveMassQuickActionTemplatesResponseResultItem) : sprintf('%s(%s)', gettype($retrieveMassQuickActionTemplatesResponseResultItem), var_export($retrieveMassQuickActionTemplatesResponseResultItem, true));
            }
        }
     ...
     * @param \SFPartnerApi\v480\StructType\QuickActionTemplateResult[] $result
     * @return \SFPartnerApi\v480\StructType\RetrieveMassQuickActionTemplatesResponse
     */
