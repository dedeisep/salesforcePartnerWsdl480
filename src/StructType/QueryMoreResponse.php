...
/**
 * This class stands for queryMoreResponse StructType
 * @subpackage Structs
 */
class QueryMoreResponse extends AbstractStructBase
{
    /**
     * The result
     ...
     * @uses QueryMoreResponse::setResult()
     ...
     * Set result value
     * @param \SFPartnerApi\v480\StructType\QueryResult $result
     * @return \SFPartnerApi\v480\StructType\QueryMoreResponse
     */
