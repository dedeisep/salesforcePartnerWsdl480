...
/**
 * This class stands for findDuplicates StructType
 * @subpackage Structs
 */
class FindDuplicates extends AbstractStructBase
{
    /**
     * The sObjects
    ...
    public $sObjects;
    /**
     * Constructor method for findDuplicates
     * @uses FindDuplicates::setSObjects()
    ...
    public static function validateSObjectsForArrayConstraintsFromSetSObjects(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $findDuplicatesSObjectsItem) {
            // validation for constraint: itemType
            if (!$findDuplicatesSObjectsItem instanceof \SFPartnerApi\v480\StructType\SObject) {
                $invalidValues[] = is_object($findDuplicatesSObjectsItem) ? get_class($findDuplicatesSObjectsItem) : sprintf('%s(%s)', gettype($findDuplicatesSObjectsItem), var_export($findDuplicatesSObjectsItem, true));
            }
        }
     ...
     * @param \SFPartnerApi\v480\StructType\SObject[] $sObjects
     * @return \SFPartnerApi\v480\StructType\FindDuplicates
     */
