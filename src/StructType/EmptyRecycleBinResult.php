...
/**
 * This class stands for EmptyRecycleBinResult StructType
 * @subpackage Structs
 */
class EmptyRecycleBinResult extends AbstractStructBase
{
    /**
     * The errors
    ...
    public $success;
    /**
     * Constructor method for EmptyRecycleBinResult
     * @uses EmptyRecycleBinResult::setErrors()
     * @uses EmptyRecycleBinResult::setId()
     * @uses EmptyRecycleBinResult::setSuccess()
    ...
    public static function validateErrorsForArrayConstraintsFromSetErrors(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $emptyRecycleBinResultErrorsItem) {
            // validation for constraint: itemType
            if (!$emptyRecycleBinResultErrorsItem instanceof \SFPartnerApi\v480\StructType\Error) {
                $invalidValues[] = is_object($emptyRecycleBinResultErrorsItem) ? get_class($emptyRecycleBinResultErrorsItem) : sprintf('%s(%s)', gettype($emptyRecycleBinResultErrorsItem), var_export($emptyRecycleBinResultErrorsItem, true));
            }
        }
