...
/**
 * This class stands for getDeleted StructType
 * @subpackage Structs
 */
class GetDeleted extends AbstractStructBase
{
    /**
     * The sObjectType
     * @var string
    ...
    public $endDate;
    /**
     * Constructor method for getDeleted
     * @uses GetDeleted::setSObjectType()
     * @uses GetDeleted::setStartDate()
     * @uses GetDeleted::setEndDate()
     ...
     * @param string $sObjectType
     * @return \SFPartnerApi\v480\StructType\GetDeleted
     */
